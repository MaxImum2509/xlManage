...
## Tâches
- [ ] Installer les dépendances de test avec Poetry
- [ ] Créer le fichier `pytest.ini` avec la configuration requise
- [ ] Créer le fichier `tests/conftest.py` avec les fixtures et hooks globaux
- [ ] Tester la configuration avec un test simple
- [ ] Vérifier que la couverture de code est mesurée correctement
