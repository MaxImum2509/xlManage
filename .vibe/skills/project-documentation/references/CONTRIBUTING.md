# CONTRIBUTING.md - Format et Structure

## Emplacement
`_dev/CONTRIBUTING.md`

## But
Documenter comment contribuer au projet xlManage, incluant les conventions de code, le processus de pull request, et les attentes envers les contributeurs.
...
#### 1. Introduction
Brève présentation du projet et de ce qui est recherché.

```markdown
## Introduction

xlManage est un utilitaire CLI en Python pour contrôler Excel via l'automatisation COM.
Nous recherchons des contributions pour améliorer les fonctionnalités, corriger des bugs,
et améliorer la documentation.

Voir [TODO.md](TODO.md) pour la liste des tâches à accomplir.
```

#### 2. Comment contribuer
Différentes manières de contribuer.
...
Voir le template complet dans `assets/CONTRIBUTING_template.md` pour un exemple de fichier CONTRIBUTING.md complet et prêt à l'emploi.
